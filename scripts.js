...
function updateTotals() {
    try {
        ...
        for (let item = 0; item < items.length; item++) {
            ...
            //Remove caracteres não numéricos e substitui a vírgula em ponto.
        ...
        //Formata o valor e remove o R$ que será adicionado na span com um estilo customizado.
        total = formatCurrencyBRL(total).toUpperCase().replace("R$", "")

        //Limpa o conteúdo do elemento.
        expensesTotal.innerHTML = ""

        //Adiciona o símbolo de R$ e o valor total formatado.
...
//Captura o evento de clique na lista para remover um item.
